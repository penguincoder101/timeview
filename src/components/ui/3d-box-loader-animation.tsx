...
const Loader = () => {
  const loaderCss = `
    .loader {
      --duration: 3s;
      /* Updated colors to match your app's blue/purple theme */
      --primary: rgba(59, 130, 246, 1); /* Blue-500 */
      --primary-light: rgba(147, 51, 234, 1); /* Purple-600 */
      --primary-rgba: rgba(59, 130, 246, 0);
      width: 200px;
      height: 320px;
      position: relative;
    ...
    .loader:before, .loader:after {
      ...
      right: 32%;
      bottom: -11px;
      /* Updated to match your app's gray-900 background */
      background: #111827; 
