...
export type PageType = 'topicSelection' | 'timelineView' | 'addTopic' | 'editTopic' | 'adminPage' | 'organizationDashboard' | 'authPage';
...
export type OrgDashboardSection = 'overview' | 'topics' | 'members' | 'settings';