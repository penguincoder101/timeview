/*
  # Topic Permissions Migration - Fix Function Uniqueness

  1. Drop existing policies and functions with CASCADE
  2. Recreate helper functions with proper signatures
  3. Create refined topic policies with new permission logic
  4. Recreate all dependent policies that were dropped
*/
...
-- Be specific about function signatures to avoid ambiguity
